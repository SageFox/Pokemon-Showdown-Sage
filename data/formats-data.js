exports.BattleFormatsData = {
	...
	harpee: { isNonstandard: true, tier: "VP" },
	aquilor: { isNonstandard: true, tier: "VP" },
	warquila: { isNonstandard: true, tier: "VP" },
	
	capig: { isNonstandard: true, tier: "VP" },
	capabara: { isNonstandard: true, tier: "VP" },
	
	cubzero: { isNonstandard: true, tier: "VP" },
	avalynx: { isNonstandard: true, tier: "VP" },
	
	fawning: { isNonstandard: true, tier: "VP" },
	llamarsh: { isNonstandard: true, tier: "VP" },
	buckston: { isNonstandard: true, tier: "VP" },
	pengliff: { isNonstandard: true, tier: "VP" },
	penglacier: { isNonstandard: true, tier: "VP" },
	bluffin: { isNonstandard: true, tier: "VP" },
	burrmudail: { isNonstandard: true, tier: "VP" },
	koblin: { isNonstandard: true, tier: "VP" },
	koberus: { isNonstandard: true, tier: "VP" },
	kobalt: { isNonstandard: true, tier: "VP" },
	pebblosa: { isNonstandard: true, tier: "VP" },
	terratetra: { isNonstandard: true, tier: "VP" },
	gigaard: { isNonstandard: true, tier: "VP" },
	cowatti: { isNonstandard: true, tier: "VP" },
	snome: { isNonstandard: true, tier: "VP" },
	snogre: { isNonstandard: true, tier: "VP" },
	taomarin: { isNonstandard: true, tier: "VP" },
	orangutao: { isNonstandard: true, tier: "VP" },
	larvabidae: { isNonstandard: true, tier: "VP" },
	caranox: { isNonstandard: true, tier: "VP" },
	carajoule: { isNonstandard: true, tier: "VP" },
	caracrust: { isNonstandard: true, tier: "VP" },
	musburry: { isNonstandard: true, tier: "VP" },
	musbushel: { isNonstandard: true, tier: "VP" },
	berratel: { isNonstandard: true, tier: "VP" },
	growmeo: { isNonstandard: true, tier: "VP" },
	montegrew: { isNonstandard: true, tier: "VP" },
	tuliep: { isNonstandard: true, tier: "VP" },
	capulilly: { isNonstandard: true, tier: "VP" },
	dreamdery: { isNonstandard: true, tier: "VP" },
	macabra: { isNonstandard: true, tier: "VP" },
	kertruffle: { isNonstandard: true, tier: "VP" },
	mosshroom: { isNonstandard: true, tier: "VP" },
	lumishroom: { isNonstandard: true, tier: "VP" },
	perishroom: { isNonstandard: true, tier: "VP" },
	rocano: { isNonstandard: true, tier: "VP" },
	volcaroc: { isNonstandard: true, tier: "VP" },
	volcoalder: { isNonstandard: true, tier: "VP" },
	pounther: { isNonstandard: true, tier: "VP" },
	jaguile: { isNonstandard: true, tier: "VP" },
	neureka: { isNonstandard: true, tier: "VP" },
	cerebrulb: { isNonstandard: true, tier: "VP" },
	peppit: { isNonstandard: true, tier: "VP" },
	hoppanero: { isNonstandard: true, tier: "VP" },
	scovalope: { isNonstandard: true, tier: "VP" },
	pawter: { isNonstandard: true, tier: "VP" },
	huricanine: { isNonstandard: true, tier: "VP" },
	skullarva: { isNonstandard: true, tier: "VP" },
	...
	cascotta: { isNonstandard: true, tier: "VP" },
	lutrajet: { isNonstandard: true, tier: "VP" },
	alpint: { isNonstandard: true, tier: "VP" },
	forusk: { isNonstandard: true, tier: "VP" },
	platypow: { isNonstandard: true, tier: "VP" },
	platikhao: { isNonstandard: true, tier: "VP" },
	cuppy: { isNonstandard: true, tier: "VP" },
	fettlekish: { isNonstandard: true, tier: "VP" },
	shibalbat: { isNonstandard: true, tier: "VP" },
	nobunata: { isNonstandard: true, tier: "VP" },
	psybex: { isNonstandard: true, tier: "VP" },
	gnuru: { isNonstandard: true, tier: "VP" },
	flowger: { isNonstandard: true, tier: "VP" },
	bullotus: { isNonstandard: true, tier: "VP" },
	burrowl: { isNonstandard: true, tier: "VP" },
	magowl: { isNonstandard: true, tier: "VP" },
	craliber: { isNonstandard: true, tier: "VP" },
	crawglock: { isNonstandard: true, tier: "VP" },
	leafish: { isNonstandard: true, tier: "VP" },
	chlorofin: { isNonstandard: true, tier: "VP" },
	quibble: { isNonstandard: true, tier: "VP" },
	fowattle: { isNonstandard: true, tier: "VP" },
	turkistador: { isNonstandard: true, tier: "VP" },
	sedirrot: { isNonstandard: true, tier: "VP" },
	condesa: { isNonstandard: true, tier: "VP" },
	cardinite: { isNonstandard: true, tier: "VP" },
	chardinal: { isNonstandard: true, tier: "VP" },
	skurrow: { isNonstandard: true, tier: "VP" },
	somberado: { isNonstandard: true, tier: "VP" },
	phlask: { isNonstandard: true, tier: "VP" },
	noxial: { isNonstandard: true, tier: "VP" },
	fumighast: { isNonstandard: true, tier: "VP" },
	atomite: { isNonstandard: true, tier: "VP" },
	orbatom: { isNonstandard: true, tier: "VP" },
	squink: { isNonstandard: true, tier: "VP" },
	squidrift: { isNonstandard: true, tier: "VP" },
	boarealis: { isNonstandard: true, tier: "VP" },
	chelonite: { isNonstandard: true, tier: "VP" },
	galaxagos: { isNonstandard: true, tier: "VP" },
	magnitogre: { isNonstandard: true, tier: "VP" },
	minarac: { isNonstandard: true, tier: "VP" },
	trenchula: { isNonstandard: true, tier: "VP" },
	pottle: { isNonstandard: true, tier: "VP" },
	trikotta: { isNonstandard: true, tier: "VP" },
	terrorcotta: { isNonstandard: true, tier: "VP" },
	pueblant: { isNonstandard: true, tier: "VP" },
	cahokisect: { isNonstandard: true, tier: "VP" },
	cobrascet: { isNonstandard: true, tier: "VP" },
	charmbra: { isNonstandard: true, tier: "VP" },
	cairup: { isNonstandard: true, tier: "VP" },
	kairoglyph: { isNonstandard: true, tier: "VP" },
	necronite: { isNonstandard: true, tier: "VP" },
	gravollum: { isNonstandard: true, tier: "VP" },
	diloweed: { isNonstandard: true, tier: "VP" },
	pangolash: { isNonstandard: true, tier: "VP" },
	ignishell: { isNonstandard: true, tier: "VP" },
	shelosene: { isNonstandard: true, tier: "VP" },
	flarrapin: { isNonstandard: true, tier: "VP" },
	deoulsa: { isNonstandard: true, tier: "VP" },
	necrow: { isNonstandard: true, tier: "VP" },
	vultergyst: { isNonstandard: true, tier: "VP" },
	dinkywink: { isNonstandard: true, tier: "VP" },
	dunkywunkr: { isNonstandard: true, tier: "VP" },
	calphite: { isNonstandard: true, tier: "VP" },
	indrolith: { isNonstandard: true, tier: "VP" },
	solacari: { isNonstandard: true, tier: "VP" },
	nurshary: { isNonstandard: true, tier: "VP" },
	loneleaf: { isNonstandard: true, tier: "VP" },
	forthorn: { isNonstandard: true, tier: "VP" },
	coltergeist: { isNonstandard: true, tier: "VP" },
	fantasmare: { isNonstandard: true, tier: "VP" },
	chihaha: { isNonstandard: true, tier: "VP" },
	howlequin: { isNonstandard: true, tier: "VP" },
	chegrin: { isNonstandard: true, tier: "VP" },
	cheshade: { isNonstandard: true, tier: "VP" },
	doppole: { isNonstandard: true, tier: "VP" },
	artifish: { isNonstandard: true, tier: "VP" },
	thoraxe: { isNonstandard: true, tier: "VP" },
	pomparunt: { isNonstandard: true, tier: "VP" },
	pompagoon: { isNonstandard: true, tier: "VP" },
	hyekuza: { isNonstandard: true, tier: "VP" },
	erycoon: { isNonstandard: true, tier: "VP" },
	leukoon: { isNonstandard: true, tier: "VP" },
	toxito: { isNonstandard: true, tier: "VP" },
	sanguito: { isNonstandard: true, tier: "VP" },
	orett: { isNonstandard: true, tier: "VP" },
	anvelid: { isNonstandard: true, tier: "VP" },
	magroplex: { isNonstandard: true, tier: "VP" },
	viipii: { isNonstandard: true, tier: "VP" },
	chilloth: { isNonstandard: true, tier: "VP" },
	soakoth: { isNonstandard: true, tier: "VP" },
	chayan: { isNonstandard: true, tier: "VP" },
	macuarrior: { isNonstandard: true, tier: "VP" },
	ocerumi: { isNonstandard: true, tier: "VP" },
	fortifry: { isNonstandard: true, tier: "VP" },
	oarwish: { isNonstandard: true, tier: "VP" },
	smashiary: { isNonstandard: true, tier: "VP" },
	slatic: { isNonstandard: true, tier: "VP" },
	telsion: { isNonstandard: true, tier: "VP" },
	chameleohm: { isNonstandard: true, tier: "VP" },
	glauqua: { isNonstandard: true, tier: "VP" },
	hydranticus: { isNonstandard: true, tier: "VP" },
	lintle: { isNonstandard: true, tier: "VP" },
	silkinder: { isNonstandard: true, tier: "VP" },
	paramoth: { isNonstandard: true, tier: "VP" },
	parapy: { isNonstandard: true, tier: "VP" },
	mawasite: { isNonstandard: true, tier: "VP" },
	chimpoca: { isNonstandard: true, tier: "VP" },
	simayan: { isNonstandard: true, tier: "VP" },
	monkezuma: { isNonstandard: true, tier: "VP" },
	enigmite: { isNonstandard: true, tier: "VP" },
	enigmantis: { isNonstandard: true, tier: "VP" },
	arjibi: { isNonstandard: true, tier: "VP" },
	royjibiv: { isNonstandard: true, tier: "VP" },
	barracute: { isNonstandard: true, tier: "VP" },
	jawgodon: { isNonstandard: true, tier: "VP" },
	drosire: { isNonstandard: true, tier: "VP" },
	sunduke: { isNonstandard: true, tier: "VP" },
	wispern: { isNonstandard: true, tier: "VP" },
	phantern: { isNonstandard: true, tier: "VP" },
	glocto: { isNonstandard: true, tier: "VP" },
	lavoon: { isNonstandard: true, tier: "VP" },
	gilla: { isNonstandard: true, tier: "VP" },
	hornizard: { isNonstandard: true, tier: "VP" },
	ankillosore: { isNonstandard: true, tier: "VP" },
	bazilisk: { isNonstandard: true, tier: "VP" },
	ornitherb: { isNonstandard: true, tier: "VP" },
	dilophlora: { isNonstandard: true, tier: "VP" },
	baboom: { isNonstandard: true, tier: "VP" },
	icetope: { isNonstandard: true, tier: "VP" },
	chillnobyl: { isNonstandard: true, tier: "VP" },
	wendingo: { isNonstandard: true, tier: "VP" },
	carnibal: { isNonstandard: true, tier: "VP" },
	luchito: { isNonstandard: true, tier: "VP" },
	eluchadon: { isNonstandard: true, tier: "VP" },
	grolem: { isNonstandard: true, tier: "VP" },
	comossus: { isNonstandard: true, tier: "VP" },
	larvyn: { isNonstandard: true, tier: "VP" },
	dracoon: { isNonstandard: true, tier: "VP" },
	basilect: { isNonstandard: true, tier: "VP" },
	carbite: { isNonstandard: true, tier: "VP" },
	pressaur: { isNonstandard: true, tier: "VP" },
	diamat: { isNonstandard: true, tier: "VP" },
	quecko: { isNonstandard: true, tier: "VP" },
	tozecko: { isNonstandard: true, tier: "VP" },
	crakling: { isNonstandard: true, tier: "VP" },
	fuelong: { isNonstandard: true, tier: "VP" },
	draggar: { isNonstandard: true, tier: "VP" },
	ragnarow: { isNonstandard: true, tier: "VP" },
	eronze: { isNonstandard: true, tier: "VP" },
	erion: { isNonstandard: true, tier: "VP" },
	erace: { isNonstandard: true, tier: "VP" },
	patama: { isNonstandard: true, tier: "VP" },
	machima: { isNonstandard: true, tier: "VP" },
